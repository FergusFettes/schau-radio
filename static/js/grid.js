    ...
    Preview.prototype = {
        create : function() {
            ...
            this.$dimensions = $('<p></p>');
						...
						this.$href2 = $( '<a href="#" target="_blank">{{ .Site.Params.buttontext2 }}</a>' );
            this.$details = $('<div class="og-details"></div>').append(this.$title, this.$description, this.$mediums, this.$dimensions, this.$href, this.$href2);
